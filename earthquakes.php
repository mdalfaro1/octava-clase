...
<div class="col-sm-12 col-lg-10 col-lg-offset-1">
  <section>
    ...
    <?php $cl++ ;?>
    <li
    <?php if ($json_data['features'][$n]['properties']['mag'] >= 6){?> style="color:RGB(224, 21, 36);"
       <?php } elseif($json_data['features'][$n]['properties']['mag'] >= 5){ ?> style="color:RGB(149, 83, 84);"
          <?php } elseif($json_data['features'][$n]['properties']['mag'] >= 4.5){ ?> style="color:RGB(0, 0, 84);"
            <?php } elseif($json_data['features'][$n]['properties']['mag'] >= 5){ ?> style="color:RGB(255, 255, 15);"
              <?php } elseif($json_data['features'][$n]['properties']['mag'] >= 5.5){ ?> style="color:RGB(18, 80, 30);"
                <?php } elseif($json_data['features'][$n]['properties']['mag'] >= 5.5){ ?> style="color:RGB(18, 80, 30);"
                  <?php } elseif($json_data['features'][$n]['properties']['mag'] >= 6){ ?> style="color:RGB(40, 20, 40);"
                    <?php } elseif($json_data['features'][$n]['properties']['mag'] >= 6){ ?> style="color:RGB(250, 250, 0);"
          <?php }else{ ?> style="color:RGB(100, 100, 100);"
            <?php };?>>
