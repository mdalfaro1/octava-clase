...
<h2>Temperatura: <?php echo round($json_data['data']['sensors'][3]['value'],1);?>ºC</h2>
<h2>Humedad: <?php echo round($json_data['data']['sensors'][2]['uuid'],1);?>%</h2>
<h2>Ruido: <?php echo round($json_data['data']['sensors'][7]['uuid'],1);?>dB</h2>
